...
case $option in
		...
		99) echo "#########################################"
			...
			echo "- After installation you need to add targets (ip-addresses of your exporters) for prometheus and data source (prometheus database) for grafana"
			echo "--------------------------------------------------------------------"
			echo "How it works:"
			...
			echo "3. systemcttl daemon-reload && systemctl restart prometheus"
